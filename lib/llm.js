...
const PROVIDER_ORDER = ["anthropic", "openai", "deepseek", "groq", "google"];
const PROVIDER_ENV = {
...
export function resolveProvider() {
  ...
  throw new Error(
    "Koi bhi model API key set nahi hai server pe. Vercel env vars mein ANTHROPIC_API_KEY, OPENAI_API_KEY, DEEPSEEK_API_KEY, GROQ_API_KEY, ya GOOGLE_API_KEY mein se ek daal ke redeploy kar."
  );
}
